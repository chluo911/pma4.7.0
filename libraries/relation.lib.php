 ...
 * @return string
 */
function PMA_getDiagMessageForFeature(
    $feature_name,
    $relation_parameter,
    $messages,
    $skip_line = true
 ...
 * @return string
 */
function PMA_getDiagMessageForParameter(
    $parameter,
 ...
 * @return void
 */
function PMA_REL_renameSingleTable(
    $table,
    $source_db,
    $target_db,
    $source_table,
...
function PMA_getChildReferences($db, $table, $column = '')
{
    ...
    if (! $GLOBALS['cfg']['Server']['DisableIS']) {
        ...
        $child_references = $GLOBALS['dbi']->fetchResult(
            $rel_query,
            array('referenced_column_name', null)
        );
    }
