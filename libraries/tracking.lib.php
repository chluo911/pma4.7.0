 ...
 * @return string
 */
function PMA_getHtmlForDataDefinitionAndManipulationStatements(
    $url_query,
    $last_version,
    $db,
    $selected,
 ...
 * @return string
 */
function PMA_getHtmlForTrackingReport(
    $url_query,
    $data,
    $url_params,
    $selection_schema,
 ...
 * @return string
 */
function PMA_getHtmlForDataManipulationStatements(
    $data,
    $filter_users,
    $filter_ts_from,
    $filter_ts_to,
 ...
 * @return string
 */
function PMA_getHtmlForOneStatement(
    $entry,
    $filter_users,
    $filter_ts_from,
    $filter_ts_to,
 ...
 * @return array
 */
function PMA_getHtmlForDataDefinitionStatements(
    $data,
    $filter_users,
    $filter_ts_from,
    $filter_ts_to,
 ...
 * @return array
 */
function PMA_getHtmlForDataStatements(
    $data,
    $filter_users,
    $filter_ts_from,
    $filter_ts_to,
